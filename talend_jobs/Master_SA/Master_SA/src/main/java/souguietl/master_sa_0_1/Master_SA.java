...
package souguietl.master_sa_0_1;
...
/**
 * Job: Master_SA Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 8.0.1.20211109_1610
 * @status 
 */
public class Master_SA implements TalendJob {
...
protected static void logIgnoredError(String message, Throwable cause) {
	...
	private final String jobName = "Master_SA";
		...
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(Master_SA.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
 ...
 */
	...
	Object obj_tRunJob_2 = null;
		...
		souguietl.entete_achat_sa_0_1.Entete_achat_SA childJob_tRunJob_2 = new souguietl.entete_achat_sa_0_1.Entete_achat_SA();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_7 = null;
		...
		souguietl.ligne_achat_sa_0_1.Ligne_achat_SA childJob_tRunJob_7 = new souguietl.ligne_achat_sa_0_1.Ligne_achat_SA();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_8 = null;
		...
		souguietl.produits_ileyckom_sa_0_1.Produits_Ileyckom_SA childJob_tRunJob_8 = new souguietl.produits_ileyckom_sa_0_1.Produits_Ileyckom_SA();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_9 = null;
		...
		souguietl.produits_kalys_sa_0_1.Produits_Kalys_SA childJob_tRunJob_9 = new souguietl.produits_kalys_sa_0_1.Produits_Kalys_SA();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_10 = null;
		...
		souguietl.produits_sougui_sa_0_1.Produits_Sougui_SA childJob_tRunJob_10 = new souguietl.produits_sougui_sa_0_1.Produits_Sougui_SA();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_3 = null;
		...
		souguietl.entete_vente_sa_0_1.Entete_vente_SA childJob_tRunJob_3 = new souguietl.entete_vente_sa_0_1.Entete_vente_SA();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_4 = null;
		...
		souguietl.ligne_vente_sa_0_1.Ligne_vente_SA childJob_tRunJob_4 = new souguietl.ligne_vente_sa_0_1.Ligne_vente_SA();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_5 = null;
		...
		souguietl.entete_bl_sa_0_1.Entete_bl_SA childJob_tRunJob_5 = new souguietl.entete_bl_sa_0_1.Entete_bl_SA();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_6 = null;
		...
		souguietl.ligne_bl_sa_0_1.Ligne_bl_SA childJob_tRunJob_6 = new souguietl.ligne_bl_sa_0_1.Ligne_bl_SA();
	    // pass DataSources
 ...
 */
    ...
    public static void main(String[] args){
        final Master_SA Master_SAClass = new Master_SA();

        int exitCode = Master_SAClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = Master_SA.class.getClassLoader().getResourceAsStream("souguietl/master_sa_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = Master_SA.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : Master_SA");
        }
...
/************************************************************************************************
 *     86906 characters generated by Talend Open Studio for Data Integration 
