...
package souguietl.dim_produit_ileyckom_0_1;
...
/**
 * Job: Dim_Produit_Ileyckom Purpose: <br>
 * Description:  <br>
 * @author 
 * @version 8.0.1.20211109_1610
 * @status 
 */
public class Dim_Produit_Ileyckom implements TalendJob {
...
protected static void logIgnoredError(String message, Throwable cause) {
	...
	private final String jobName = "Dim_Produit_Ileyckom";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				Dim_Produit_Ileyckom.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(Dim_Produit_Ileyckom.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class ajoutStruct implements routines.system.IPersistableRow<ajoutStruct> {
    final static byte[] commonByteArrayLock_SOUGUIETL_Dim_Produit_Ileyckom = new byte[0];
    static byte[] commonByteArray_SOUGUIETL_Dim_Produit_Ileyckom = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_SOUGUIETL_Dim_Produit_Ileyckom.length) {
				if(length < 1024 && commonByteArray_SOUGUIETL_Dim_Produit_Ileyckom.length == 0) {
   					commonByteArray_SOUGUIETL_Dim_Produit_Ileyckom = new byte[1024];
				} else {
   					commonByteArray_SOUGUIETL_Dim_Produit_Ileyckom = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_SOUGUIETL_Dim_Produit_Ileyckom, 0, length);
			strReturn = new String(commonByteArray_SOUGUIETL_Dim_Produit_Ileyckom, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_SOUGUIETL_Dim_Produit_Ileyckom, 0, length);
			strReturn = new String(commonByteArray_SOUGUIETL_Dim_Produit_Ileyckom, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_SOUGUIETL_Dim_Produit_Ileyckom) {
...
public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
    ...
    static byte[] commonByteArray_SOUGUIETL_Dim_Produit_Ileyckom = new byte[0];
			    ...
			    public String Sougui_Reference;

				public String getSougui_Reference () {
					return this.Sougui_Reference;
				}
		...
		synchronized(commonByteArrayLock_SOUGUIETL_Dim_Produit_Ileyckom) {
        	...
        	try {
        		...
        		int length = 0;
					...
					this.Sougui_Reference = readString(dis);
    ...
    public void writeData(ObjectOutputStream dos) {
        try {
					...
					// String
						...
						writeString(this.Sougui_Reference,dos);
    ...
    public String toString() {
		...
		sb.append(super.toString());
		sb.append("[");
		sb.append("Sougui_Reference="+Sougui_Reference);
...
String dbUser_tDBOutput_1 = null;
	...
	final String decryptedPassword_tDBOutput_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:QUgBBzJgWnn6zU8bYoITWnTHArCDB+m4CBff8XHzU4Zp3vG1");
...
if(dbschema_tDBOutput_1 == null || dbschema_tDBOutput_1.trim().length() == 0) {
    tableName_tDBOutput_1 = "Dim_Produit_Ileyckom";
} else {
    tableName_tDBOutput_1 = dbschema_tDBOutput_1 + "].[" + "Dim_Produit_Ileyckom";
}
	int count_tDBOutput_1=0;

        String insert_tDBOutput_1 = "INSERT INTO [" + tableName_tDBOutput_1 + "] ([product_name],[categories],[price],[reference],[source]) VALUES (?,?,?,?,?)";
...
String dbUser_tDBOutput_2 = null;
	...
	final String decryptedPassword_tDBOutput_2 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:bH0O5xNpNyMKFSohd32939190Z2DBFRBpGo3GTMRGw45tp+I");
...
if(dbschema_tDBOutput_2 == null || dbschema_tDBOutput_2.trim().length() == 0) {
    tableName_tDBOutput_2 = "Dim_Produit_Ileyckom";
} else {
    tableName_tDBOutput_2 = dbschema_tDBOutput_2 + "].[" + "Dim_Produit_Ileyckom";
}
	int count_tDBOutput_2=0;

        String update_tDBOutput_2 = "UPDATE [" + tableName_tDBOutput_2 + "] SET [product_name] = ?,[categories] = ?,[price] = ?,[reference] = ?,[source] = ? WHERE [Produit_Ileyckom_Id] = ?";
 ...
 */
	...
	final String decryptedPassword_tDBInput_2 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:oM8S1tG4/LyKQMWLC8ySnuEe0/SzX9hlA5tM39RwKsoWhfgG");
		    ...
		    String dbquery_tDBInput_2 = "SELECT \n    Sougui_Reference,\n    MAX(Original_Iley_Name) AS Original_Iley_Name,\n    MAX(Original_Iley_Category) AS "
+"Original_Iley_Category,\n    MAX(Iley_Price) AS Iley_Price,\n    MAX(Source) AS Source\nFROM dbo.Produits_Ileyckom_SA\nG"
+"ROUP BY Sougui_Reference;";
            ...
            if(tmpContent_tDBInput_2 != null) {
            	if (talendToDBList_tDBInput_2 .contains(rsmd_tDBInput_2.getColumnTypeName(1).toUpperCase(java.util.Locale.ENGLISH))) {
            		row1.Sougui_Reference = FormatterUtils.formatUnwithE(tmpContent_tDBInput_2);
            	} else {
                	row1.Sougui_Reference = tmpContent_tDBInput_2;
                }
            } else {
                row1.Sougui_Reference = null;
            }
            ...
            if(tmpContent_tDBInput_2 != null) {
            	if (talendToDBList_tDBInput_2 .contains(rsmd_tDBInput_2.getColumnTypeName(2).toUpperCase(java.util.Locale.ENGLISH))) {
            		row1.Original_Iley_Name = FormatterUtils.formatUnwithE(tmpContent_tDBInput_2);
            	} else {
                	row1.Original_Iley_Name = tmpContent_tDBInput_2;
                }
            } else {
                row1.Original_Iley_Name = null;
            }
            ...
            if(tmpContent_tDBInput_2 != null) {
            	if (talendToDBList_tDBInput_2 .contains(rsmd_tDBInput_2.getColumnTypeName(3).toUpperCase(java.util.Locale.ENGLISH))) {
            		row1.Original_Iley_Category = FormatterUtils.formatUnwithE(tmpContent_tDBInput_2);
            	} else {
                	row1.Original_Iley_Category = tmpContent_tDBInput_2;
                }
            } else {
                row1.Original_Iley_Category = null;
            }
            ...
            row1.Iley_Price = rs_tDBInput_2.getFloat(4);
            ...
            if(tmpContent_tDBInput_2 != null) {
            	if (talendToDBList_tDBInput_2 .contains(rsmd_tDBInput_2.getColumnTypeName(5).toUpperCase(java.util.Locale.ENGLISH))) {
            		row1.Source = FormatterUtils.formatUnwithE(tmpContent_tDBInput_2);
            	} else {
 					    ...
 					    boolean forceLooprow2 = false;
 							...
 							row2Struct row2ObjectFromLookup = null;
								...
								hasCasePrimitiveKeyWithNull_tMap_2 = false;
                        		    		    ...
                        		    		    row2HashKey.reference = row1.Sougui_Reference ;
...
ajout_tmp.product_name = row1.Original_Iley_Name ;
ajout_tmp.categories = row1.Original_Iley_Category ;
ajout_tmp.price = row1.Iley_Price ;
ajout_tmp.reference = row1.Sougui_Reference ;
ajout_tmp.source = row1.Source ;
ajout = ajout_tmp;
...
modify_tmp.Produit_Ileyckom_Id = row2.Produit_Ileyckom_Id ;
modify_tmp.product_name = row1.Original_Iley_Name ;
modify_tmp.categories = row1.Original_Iley_Category ;
modify_tmp.price = row1.Iley_Price ;
modify_tmp.reference = row1.Sougui_Reference ;
modify_tmp.source = row1.Source ;
modify = modify_tmp;
} // closing filter/reject
// ###############################
...
if(ajout != null) { 
	...
	currentComponent="tDBOutput_1";
        ...
        whetherReject_tDBOutput_1 = false;
                    if(ajout.product_name == null) {
pstmt_tDBOutput_1.setNull(1, java.sql.Types.VARCHAR);
} else {String driver = null;
driver = "MSSQL_PROP";
if ("MSSQL_PROP".equals(driver)) {
pstmt_tDBOutput_1.setNString(1, ajout.product_name);
} else {
pstmt_tDBOutput_1.setString(1, ajout.product_name);
}
}

                    if(ajout.categories == null) {
pstmt_tDBOutput_1.setNull(2, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(2, ajout.categories);
}

                    if(ajout.price == null) {
pstmt_tDBOutput_1.setNull(3, java.sql.Types.FLOAT);
} else {pstmt_tDBOutput_1.setFloat(3, ajout.price);
}

                    if(ajout.reference == null) {
pstmt_tDBOutput_1.setNull(4, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(4, ajout.reference);
}

                    if(ajout.source == null) {
pstmt_tDBOutput_1.setNull(5, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(5, ajout.source);
}
...
if(modify != null) { 
	...
	currentComponent="tDBOutput_2";
        ...
        whetherReject_tDBOutput_2 = false;
                    if(modify.product_name == null) {
pstmt_tDBOutput_2.setNull(1, java.sql.Types.VARCHAR);
} else {String driver = null;
driver = "MSSQL_PROP";
if ("MSSQL_PROP".equals(driver)) {
pstmt_tDBOutput_2.setNString(1, modify.product_name);
} else {
pstmt_tDBOutput_2.setString(1, modify.product_name);
}
}

                    if(modify.categories == null) {
pstmt_tDBOutput_2.setNull(2, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_2.setString(2, modify.categories);
}

                    if(modify.price == null) {
pstmt_tDBOutput_2.setNull(3, java.sql.Types.FLOAT);
} else {pstmt_tDBOutput_2.setFloat(3, modify.price);
}

                    if(modify.reference == null) {
pstmt_tDBOutput_2.setNull(4, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_2.setString(4, modify.reference);
}

                    if(modify.source == null) {
pstmt_tDBOutput_2.setNull(5, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_2.setString(5, modify.source);
}


                    pstmt_tDBOutput_2.setInt(6 + count_tDBOutput_2, modify.Produit_Ileyckom_Id);
 ...
 final boolean execStat = this.execStat;
	...
	currentComponent="tAdvancedHash_row2";
		...
		int tos_count_tAdvancedHash_row2 = 0;
			   		...
			   		// linked node: tMap_2 - inputs:(row1,row2) outputs:(ajout,modify)
 ...
 */
	...
	final String decryptedPassword_tDBInput_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:UZwBtPiQaQNJv56GhsH4ADshxYzhP1IMXPStRuXjYOxGPPmZ");
				
				String dbPwd_tDBInput_1 = decryptedPassword_tDBInput_1;
				
		    String port_tDBInput_1 = "1433";
		    String dbname_tDBInput_1 = "Sougui_DWH" ;		    
		    String url_tDBInput_1 = "jdbc:sqlserver://" + "DESKTOP-LBCVIS5" ;
		    if (!"".equals(port_tDBInput_1)) {
		    	url_tDBInput_1 += ":" + "1433";
		    }
		    if (!"".equals(dbname_tDBInput_1)) {		    
		    	url_tDBInput_1 += ";databaseName=" + "Sougui_DWH"; 
		    }
		    ...
		    String dbquery_tDBInput_1 = "SELECT dbo.Dim_Produit_Ileyckom.Produit_Ileyckom_Id,\n		dbo.Dim_Produit_Ileyckom.reference,\n		dbo.Dim_Produit_Ileyckom.s"
...
+"FROM	dbo.Dim_Produit_Ileyckom";
		    ...
		    while (rs_tDBInput_1.next()) {
		        nb_line_tDBInput_1++;
							...
							if(colQtyInRs_tDBInput_1 < 1) {
								row2.Produit_Ileyckom_Id = 0;
							} else {
		                          
            row2.Produit_Ileyckom_Id = rs_tDBInput_1.getInt(1);
            ...
            if(tmpContent_tDBInput_1 != null) {
            	if (talendToDBList_tDBInput_1 .contains(rsmd_tDBInput_1.getColumnTypeName(2).toUpperCase(java.util.Locale.ENGLISH))) {
            		row2.reference = FormatterUtils.formatUnwithE(tmpContent_tDBInput_1);
            	} else {
                	row2.reference = tmpContent_tDBInput_1;
                }
            } else {
                row2.reference = null;
            }
            ...
            if(tmpContent_tDBInput_1 != null) {
            	if (talendToDBList_tDBInput_1 .contains(rsmd_tDBInput_1.getColumnTypeName(4).toUpperCase(java.util.Locale.ENGLISH))) {
            		row2.product_name = FormatterUtils.formatUnwithE(tmpContent_tDBInput_1);
            	} else {
                	row2.product_name = tmpContent_tDBInput_1;
                }
            } else {
                row2.product_name = null;
            }
            ...
            row2.price = rs_tDBInput_1.getBigDecimal(5);
            if(rs_tDBInput_1.wasNull()){
                    row2.price = null;
            }
		                    }
            ...
            if(tmpContent_tDBInput_1 != null) {
            	if (talendToDBList_tDBInput_1 .contains(rsmd_tDBInput_1.getColumnTypeName(6).toUpperCase(java.util.Locale.ENGLISH))) {
            		row2.categories = FormatterUtils.formatUnwithE(tmpContent_tDBInput_1);
            	} else {
                	row2.categories = tmpContent_tDBInput_1;
                }
            } else {
                row2.categories = null;
            }
 ...
 */
	...
	currentComponent="tAdvancedHash_row2";
				...
				row2_HashRow.Produit_Ileyckom_Id = row2.Produit_Ileyckom_Id;
 ...
 */
    ...
    public static void main(String[] args){
        final Dim_Produit_Ileyckom Dim_Produit_IleyckomClass = new Dim_Produit_Ileyckom();

        int exitCode = Dim_Produit_IleyckomClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = Dim_Produit_Ileyckom.class.getClassLoader().getResourceAsStream("souguietl/dim_produit_ileyckom_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = Dim_Produit_Ileyckom.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : Dim_Produit_Ileyckom");
        }
...
/************************************************************************************************
 *     121582 characters generated by Talend Open Studio for Data Integration 
 *     on the 22 mars 2026 à 16:45:13 WAT
 ************************************************************************************************/