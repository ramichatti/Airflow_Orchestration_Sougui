...
package souguietl.dim_produit_a_0_1;
...
/**
 * Job: Dim_Produit_A Purpose: <br>
 * Description:  <br>
 * @author 
 * @version 8.0.1.20211109_1610
 * @status 
 */
public class Dim_Produit_A implements TalendJob {
...
protected static void logIgnoredError(String message, Throwable cause) {
	...
	private final String jobName = "Dim_Produit_A";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				Dim_Produit_A.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(Dim_Produit_A.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class ajoutStruct implements routines.system.IPersistableRow<ajoutStruct> {
    final static byte[] commonByteArrayLock_SOUGUIETL_Dim_Produit_A = new byte[0];
    static byte[] commonByteArray_SOUGUIETL_Dim_Produit_A = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_SOUGUIETL_Dim_Produit_A.length) {
				if(length < 1024 && commonByteArray_SOUGUIETL_Dim_Produit_A.length == 0) {
   					commonByteArray_SOUGUIETL_Dim_Produit_A = new byte[1024];
				} else {
   					commonByteArray_SOUGUIETL_Dim_Produit_A = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_SOUGUIETL_Dim_Produit_A, 0, length);
			strReturn = new String(commonByteArray_SOUGUIETL_Dim_Produit_A, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_SOUGUIETL_Dim_Produit_A, 0, length);
			strReturn = new String(commonByteArray_SOUGUIETL_Dim_Produit_A, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_SOUGUIETL_Dim_Produit_A) {
...
String dbUser_tDBOutput_1 = null;
	...
	final String decryptedPassword_tDBOutput_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:B+yhwTXzaxfKdinzRz+sFYsUQzn7G1DcncHylqbCdtSCi6Pw");
...
String dbUser_tDBOutput_2 = null;
	...
	final String decryptedPassword_tDBOutput_2 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:sQ1w4LF+l+SbWiz1MnJLnpOLHkMEg+jU6BCa0RGXped7H4Ls");
 ...
 */
	...
	final String decryptedPassword_tDBInput_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:LSTEIZ/VBxsAh/8DhbSjUh10uALzzlpH8BgoTBsq8hLcbd2C");
		    ...
		    String dbquery_tDBInput_1 = "SELECT \n    reference as Reference,\n    MAX(description) AS Description,\n    MAX(prix_unitaire) AS PU_HT\nFROM Sougu"
+"i_SA.dbo.Ligne_achat_SA\nGROUP BY reference;";
...
pstmt_tDBOutput_2.setNull(3, java.sql.Types.FLOAT);
                    ...
                    pstmt_tDBOutput_2.setInt(4 + count_tDBOutput_2, modify.Id_Produit);
 ...
 */
	...
	final String decryptedPassword_tDBInput_2 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:y1OOE4OHPLGnva+gmJuSsT8w5K9lIlZBcKJPGD8Vmgi89KLM");
 ...
 */
    ...
    public static void main(String[] args){
        final Dim_Produit_A Dim_Produit_AClass = new Dim_Produit_A();

        int exitCode = Dim_Produit_AClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = Dim_Produit_A.class.getClassLoader().getResourceAsStream("souguietl/dim_produit_a_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = Dim_Produit_A.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : Dim_Produit_A");
        }
...
/************************************************************************************************
 *     112124 characters generated by Talend Open Studio for Data Integration 
