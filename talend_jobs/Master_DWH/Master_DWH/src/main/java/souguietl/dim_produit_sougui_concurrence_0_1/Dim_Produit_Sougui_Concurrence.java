...
package souguietl.dim_produit_sougui_concurrence_0_1;
...
/**
 * Job: Dim_Produit_Sougui_Concurrence Purpose: <br>
 * Description:  <br>
 * @author 
 * @version 8.0.1.20211109_1610
 * @status 
 */
public class Dim_Produit_Sougui_Concurrence implements TalendJob {
...
protected static void logIgnoredError(String message, Throwable cause) {
	...
	private final String jobName = "Dim_Produit_Sougui_Concurrence";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				Dim_Produit_Sougui_Concurrence.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(Dim_Produit_Sougui_Concurrence.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class ajoutStruct implements routines.system.IPersistableRow<ajoutStruct> {
    final static byte[] commonByteArrayLock_SOUGUIETL_Dim_Produit_Sougui_Concurrence = new byte[0];
    static byte[] commonByteArray_SOUGUIETL_Dim_Produit_Sougui_Concurrence = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_SOUGUIETL_Dim_Produit_Sougui_Concurrence.length) {
				if(length < 1024 && commonByteArray_SOUGUIETL_Dim_Produit_Sougui_Concurrence.length == 0) {
   					commonByteArray_SOUGUIETL_Dim_Produit_Sougui_Concurrence = new byte[1024];
				} else {
   					commonByteArray_SOUGUIETL_Dim_Produit_Sougui_Concurrence = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_SOUGUIETL_Dim_Produit_Sougui_Concurrence, 0, length);
			strReturn = new String(commonByteArray_SOUGUIETL_Dim_Produit_Sougui_Concurrence, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_SOUGUIETL_Dim_Produit_Sougui_Concurrence, 0, length);
			strReturn = new String(commonByteArray_SOUGUIETL_Dim_Produit_Sougui_Concurrence, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_SOUGUIETL_Dim_Produit_Sougui_Concurrence) {
...
String dbUser_tDBOutput_1 = null;
	...
	final String decryptedPassword_tDBOutput_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:n02F0TJbNrak+y7DLrixJTUhkitmtIyxE55zBT4oA1D3BjJM");
...
if(dbschema_tDBOutput_1 == null || dbschema_tDBOutput_1.trim().length() == 0) {
	...
	int count_tDBOutput_1=0;
        ...
        String insert_tDBOutput_1 = "INSERT INTO [" + tableName_tDBOutput_1 + "] ([Reference],[Nom],[Categorie],[PU_HT],[Source]) VALUES (?,?,?,?,?)";
...
String dbUser_tDBOutput_2 = null;
	...
	final String decryptedPassword_tDBOutput_2 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:+SurancMAhDNTpaLe85Ki3Kge7NwCWKjvCjOp9UMFTPC1BoV");
...
if(dbschema_tDBOutput_2 == null || dbschema_tDBOutput_2.trim().length() == 0) {
	...
	int count_tDBOutput_2=0;
        ...
        String update_tDBOutput_2 = "UPDATE [" + tableName_tDBOutput_2 + "] SET [Reference] = ?,[Nom] = ?,[Categorie] = ?,[PU_HT] = ?,[Source] = ? WHERE [Id_Produit] = ?";
 ...
 */
	...
	final String decryptedPassword_tDBInput_2 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:JE9PF4n/d9d9V7Qb7zQ4PsGhxQERtNBBwxfWNoJUs/IR9UE1");
		    ...
		    String dbquery_tDBInput_2 = "SELECT \n    Reference,\n    MAX(Nom) AS Nom,\n    MAX(Forced_Category) AS Forced_Category,\n    MAX(Prix_Unitaire_TND)"
+" AS Prix_Unitaire_TND,\n    MAX(Source) AS Source\nFROM dbo.Produits_Sougui_SA\nGROUP BY Reference;";
            ...
            if(tmpContent_tDBInput_2 != null) {
            	if (talendToDBList_tDBInput_2 .contains(rsmd_tDBInput_2.getColumnTypeName(1).toUpperCase(java.util.Locale.ENGLISH))) {
            		row1.Reference = FormatterUtils.formatUnwithE(tmpContent_tDBInput_2);
            	} else {
                	row1.Reference = tmpContent_tDBInput_2;
                }
            } else {
                row1.Reference = null;
            }
            ...
            if(tmpContent_tDBInput_2 != null) {
            	if (talendToDBList_tDBInput_2 .contains(rsmd_tDBInput_2.getColumnTypeName(3).toUpperCase(java.util.Locale.ENGLISH))) {
            		row1.Forced_Category = FormatterUtils.formatUnwithE(tmpContent_tDBInput_2);
            	} else {
                	row1.Forced_Category = tmpContent_tDBInput_2;
                }
            } else {
                row1.Forced_Category = null;
            }
            ...
            if(tmpContent_tDBInput_2 != null) {
            	if (talendToDBList_tDBInput_2 .contains(rsmd_tDBInput_2.getColumnTypeName(4).toUpperCase(java.util.Locale.ENGLISH))) {
            		row1.Prix_Unitaire_TND = FormatterUtils.formatUnwithE(tmpContent_tDBInput_2);
            	} else {
                	row1.Prix_Unitaire_TND = tmpContent_tDBInput_2;
                }
            } else {
                row1.Prix_Unitaire_TND = null;
            }
...
ajout_tmp.Categorie = row1.Forced_Category ;
ajout_tmp.PU_HT = (row1.Prix_Unitaire_TND != null && row1.Prix_Unitaire_TND.replaceAll(",", ".").trim().matches("[0-9]*\\.?[0-9]+")) ? Float.parseFloat( row1.Prix_Unitaire_TND .replaceAll(",", ".") .replaceAll("(\\..*)\\.", "$1") ) : 0.0f ;
...
modify_tmp.Categorie = row1.Forced_Category ;
modify_tmp.PU_HT = (row1.Prix_Unitaire_TND != null && row1.Prix_Unitaire_TND.replaceAll(",", ".").trim().matches("[0-9]*\\.?[0-9]+")) ? Float.parseFloat( row1.Prix_Unitaire_TND .replaceAll(",", ".") .replaceAll("(\\..*)\\.", "$1") ) : 0.0f ;
...
} else {pstmt_tDBOutput_1.setString(2, ajout.Nom);
}

                    if(ajout.Categorie == null) {
pstmt_tDBOutput_1.setNull(3, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(3, ajout.Categorie);
}

                    if(ajout.PU_HT == null) {
pstmt_tDBOutput_1.setNull(4, java.sql.Types.FLOAT);
} else {pstmt_tDBOutput_1.setFloat(4, ajout.PU_HT);
}
...
} else {pstmt_tDBOutput_2.setString(2, modify.Nom);
}

                    if(modify.Categorie == null) {
pstmt_tDBOutput_2.setNull(3, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_2.setString(3, modify.Categorie);
}

                    if(modify.PU_HT == null) {
pstmt_tDBOutput_2.setNull(4, java.sql.Types.FLOAT);
} else {pstmt_tDBOutput_2.setFloat(4, modify.PU_HT);
}
...
pstmt_tDBOutput_2.setNull(5, java.sql.Types.VARCHAR);
                    ...
                    pstmt_tDBOutput_2.setInt(6 + count_tDBOutput_2, modify.Id_Produit);
 ...
 */
	...
	final String decryptedPassword_tDBInput_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:ybUolAgKvQB5xxG8jUi503g5TPQ2PMEElsi47a9cFDV3BmiJ");
		    ...
		    String dbquery_tDBInput_1 = "SELECT dbo.Dim_Produit_Sougui.Id_Produit,\n		dbo.Dim_Produit_Sougui.Reference,\n		dbo.Dim_Produit_Sougui.Nom,\n		dbo.Dim_P"
...
+".PU_HT\nFROM	dbo.Dim_Produit_Sougui";
            ...
            row2.PU_HT = rs_tDBInput_1.getFloat(7);
            if(rs_tDBInput_1.wasNull()){
                    row2.PU_HT = null;
            }
		                    }
 ...
 */
    ...
    public static void main(String[] args){
        final Dim_Produit_Sougui_Concurrence Dim_Produit_Sougui_ConcurrenceClass = new Dim_Produit_Sougui_Concurrence();

        int exitCode = Dim_Produit_Sougui_ConcurrenceClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = Dim_Produit_Sougui_Concurrence.class.getClassLoader().getResourceAsStream("souguietl/dim_produit_sougui_concurrence_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = Dim_Produit_Sougui_Concurrence.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : Dim_Produit_Sougui_Concurrence");
        }
...
/************************************************************************************************
 *     121764 characters generated by Talend Open Studio for Data Integration 
