...
package souguietl.dim_entreprise_v_0_1;
...
/**
 * Job: Dim_Entreprise_V Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 8.0.1.20211109_1610
 * @status 
 */
public class Dim_Entreprise_V implements TalendJob {
...
protected static void logIgnoredError(String message, Throwable cause) {
	...
	private final String jobName = "Dim_Entreprise_V";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				Dim_Entreprise_V.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(Dim_Entreprise_V.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class ajoutStruct implements routines.system.IPersistableRow<ajoutStruct> {
    final static byte[] commonByteArrayLock_SOUGUIETL_Dim_Entreprise_V = new byte[0];
    static byte[] commonByteArray_SOUGUIETL_Dim_Entreprise_V = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_SOUGUIETL_Dim_Entreprise_V.length) {
				if(length < 1024 && commonByteArray_SOUGUIETL_Dim_Entreprise_V.length == 0) {
   					commonByteArray_SOUGUIETL_Dim_Entreprise_V = new byte[1024];
				} else {
   					commonByteArray_SOUGUIETL_Dim_Entreprise_V = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_SOUGUIETL_Dim_Entreprise_V, 0, length);
			strReturn = new String(commonByteArray_SOUGUIETL_Dim_Entreprise_V, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_SOUGUIETL_Dim_Entreprise_V, 0, length);
			strReturn = new String(commonByteArray_SOUGUIETL_Dim_Entreprise_V, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_SOUGUIETL_Dim_Entreprise_V) {
...
String dbUser_tDBOutput_1 = null;
	...
	final String decryptedPassword_tDBOutput_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:UgQFoy6zmamS+qiotsCfXJA/8Aai2JnNiR6d022XSFy12Kpv");
...
if(dbschema_tDBOutput_1 == null || dbschema_tDBOutput_1.trim().length() == 0) {
	...
	int count_tDBOutput_1=0;
        ...
        String insert_tDBOutput_1 = "INSERT INTO [" + tableName_tDBOutput_1 + "] ([Nom],[Matricule_fiscal],[Adresse]) VALUES (?,?,?)";
...
String dbUser_tDBOutput_2 = null;
	...
	final String decryptedPassword_tDBOutput_2 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:ZGRKdlImT755SzoT/76o6b9qeFYcFL5zSWmRbEuTfnE0ZdQB");
...
if(dbschema_tDBOutput_2 == null || dbschema_tDBOutput_2.trim().length() == 0) {
	...
	int count_tDBOutput_2=0;
        ...
        String update_tDBOutput_2 = "UPDATE [" + tableName_tDBOutput_2 + "] SET [Nom] = ?,[Matricule_fiscal] = ?,[Adresse] = ? WHERE [Id_Client] = ?";
 ...
 */
	...
	final String decryptedPassword_tDBInput_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:RodlXnJWZ6q+MpI7j+NYZAPhsW0Aepk34bYVc6yJFnXr1JZ7");
		    ...
		    String dbquery_tDBInput_1 = "SELECT DISTINCT Entete_vente_SA.Nom as Nom,\n Entete_vente_SA.Matricule_fiscal as Matricule_fiscal,\n Entete_vente_SA.A"
+"dresse as Adresse\nFROM Entete_vente_SA";
...
pstmt_tDBOutput_1.setNull(1, java.sql.Types.VARCHAR);
                        ...
                        query_tDBOutput_1 = query_tDBOutput_1.append(insertSQLSplits_tDBOutput_1[0]).append(ajout.Nom== null ?  "null" :"'" + ajout.Nom + "'").append(insertSQLSplits_tDBOutput_1[1]);
                    if(ajout.Matricule_fiscal == null) {
pstmt_tDBOutput_1.setNull(2, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(2, ajout.Matricule_fiscal);
}

                        query_tDBOutput_1 = query_tDBOutput_1.append(ajout.Matricule_fiscal== null ?  "null" :"'" + ajout.Matricule_fiscal + "'").append(insertSQLSplits_tDBOutput_1[2]);
                    if(ajout.Adresse == null) {
pstmt_tDBOutput_1.setNull(3, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(3, ajout.Adresse);
}

                        query_tDBOutput_1 = query_tDBOutput_1.append(ajout.Adresse== null ?  "null" :"'" + ajout.Adresse + "'").append(insertSQLSplits_tDBOutput_1[3]);
...
pstmt_tDBOutput_2.setNull(3, java.sql.Types.VARCHAR);
                    ...
                    pstmt_tDBOutput_2.setInt(4 + count_tDBOutput_2, modify.Id_Client);
 ...
 */
	...
	final String decryptedPassword_tDBInput_2 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:Ak8Y8se5lGdWCaaBYQDjZw4abTMIiBG4YsXrKyB0ZvcgkJ+m");
		    ...
		    String dbquery_tDBInput_2 = "SELECT dbo.Dim_Entreprise.Id_Client,\n		dbo.Dim_Entreprise.Nom,\n		dbo.Dim_Entreprise.Matricule_fiscal,\n		dbo.Dim_Entrepr"
+"ise.Adresse\nFROM	dbo.Dim_Entreprise";
            ...
            row2.Id_Client = rs_tDBInput_2.getInt(1);
            ...
            row2.Latitude = rs_tDBInput_2.getDouble(5);
            if(rs_tDBInput_2.wasNull()){
                    row2.Latitude = null;
            }
		                    }
            ...
            row2.Longitude = rs_tDBInput_2.getDouble(6);
            if(rs_tDBInput_2.wasNull()){
                    row2.Longitude = null;
            }
		                    }
 ...
 */
    ...
    public static void main(String[] args){
        final Dim_Entreprise_V Dim_Entreprise_VClass = new Dim_Entreprise_V();

        int exitCode = Dim_Entreprise_VClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = Dim_Entreprise_V.class.getClassLoader().getResourceAsStream("souguietl/dim_entreprise_v_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = Dim_Entreprise_V.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : Dim_Entreprise_V");
        }
...
/************************************************************************************************
 *     113585 characters generated by Talend Open Studio for Data Integration 
 *     on the 22 mars 2026 à 16:45:11 WAT
 ************************************************************************************************/