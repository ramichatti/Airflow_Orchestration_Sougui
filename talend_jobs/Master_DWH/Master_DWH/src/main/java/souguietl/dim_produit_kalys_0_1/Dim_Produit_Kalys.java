...
package souguietl.dim_produit_kalys_0_1;
...
/**
 * Job: Dim_Produit_Kalys Purpose: <br>
 * Description:  <br>
 * @author 
 * @version 8.0.1.20211109_1610
 * @status 
 */
public class Dim_Produit_Kalys implements TalendJob {
...
protected static void logIgnoredError(String message, Throwable cause) {
	...
	private final String jobName = "Dim_Produit_Kalys";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				Dim_Produit_Kalys.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(Dim_Produit_Kalys.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class ajoutStruct implements routines.system.IPersistableRow<ajoutStruct> {
    final static byte[] commonByteArrayLock_SOUGUIETL_Dim_Produit_Kalys = new byte[0];
    static byte[] commonByteArray_SOUGUIETL_Dim_Produit_Kalys = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_SOUGUIETL_Dim_Produit_Kalys.length) {
				if(length < 1024 && commonByteArray_SOUGUIETL_Dim_Produit_Kalys.length == 0) {
   					commonByteArray_SOUGUIETL_Dim_Produit_Kalys = new byte[1024];
				} else {
   					commonByteArray_SOUGUIETL_Dim_Produit_Kalys = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_SOUGUIETL_Dim_Produit_Kalys, 0, length);
			strReturn = new String(commonByteArray_SOUGUIETL_Dim_Produit_Kalys, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_SOUGUIETL_Dim_Produit_Kalys, 0, length);
			strReturn = new String(commonByteArray_SOUGUIETL_Dim_Produit_Kalys, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_SOUGUIETL_Dim_Produit_Kalys) {
...
public static class modifyStruct implements routines.system.IPersistableRow<modifyStruct> {
	...
	public int hashCode() {
		if (this.hashCodeDirty) {
			...
			int result = DEFAULT_HASHCODE;
							...
							result = prime * result + (int) this.Produit_Klays_Id;
	...
	public boolean equals(Object obj) {
		...
		final modifyStruct other = (modifyStruct) obj;
						...
						if (this.Produit_Klays_Id != other.Produit_Klays_Id)
							return false;
    ...
    public int compareTo(modifyStruct other) {
		...
		int returnValue = -1;
						...
						returnValue = checkNullsAndCompare(this.Produit_Klays_Id, other.Produit_Klays_Id);
						if(returnValue != 0) {
							return returnValue;
						}
...
String dbUser_tDBOutput_1 = null;
	...
	final String decryptedPassword_tDBOutput_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:tT2uJw4S9OS8zXpHCEsvQM9B6MteEOga1JvgplSPIlNEtRAB");
...
if(dbschema_tDBOutput_1 == null || dbschema_tDBOutput_1.trim().length() == 0) {
    tableName_tDBOutput_1 = "Dim_Produit_Kalys";
} else {
    tableName_tDBOutput_1 = dbschema_tDBOutput_1 + "].[" + "Dim_Produit_Kalys";
}
...
String dbUser_tDBOutput_2 = null;
	...
	final String decryptedPassword_tDBOutput_2 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:dsFTw4/PfmJfqH1+K3AxnZNe5d9K8HPaUZgpvwI+s5uaJZjD");
...
if(dbschema_tDBOutput_2 == null || dbschema_tDBOutput_2.trim().length() == 0) {
    tableName_tDBOutput_2 = "Dim_Produit_Kalys";
} else {
    tableName_tDBOutput_2 = dbschema_tDBOutput_2 + "].[" + "Dim_Produit_Kalys";
}
	int count_tDBOutput_2=0;

        String update_tDBOutput_2 = "UPDATE [" + tableName_tDBOutput_2 + "] SET [product_name] = ?,[categories] = ?,[price] = ?,[reference] = ?,[source] = ? WHERE [Produit_Klays_Id] = ?";
 ...
 */
	...
	final String decryptedPassword_tDBInput_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:lEqQYkVP+CKPsBAF0QbbVPhMAq4l89mOHvV7nlM2tys38jX3");
		    ...
		    String dbquery_tDBInput_1 = "SELECT \n    Sougui_Reference,\n    MAX(Original_Kalys_Name) AS Original_Kalys_Name,\n    MAX(Original_Kalys_Category) "
+"AS Original_Kalys_Category,\n    MAX(Kalys_Price) AS Kalys_Price,\n    MAX(Source) AS Source\nFROM dbo.Produits_Kalys_SA"
+"\nGROUP BY Sougui_Reference";
            ...
            if(tmpContent_tDBInput_1 != null) {
            	if (talendToDBList_tDBInput_1 .contains(rsmd_tDBInput_1.getColumnTypeName(1).toUpperCase(java.util.Locale.ENGLISH))) {
            		row1.Sougui_Reference = FormatterUtils.formatUnwithE(tmpContent_tDBInput_1);
            	} else {
                	row1.Sougui_Reference = tmpContent_tDBInput_1;
                }
            } else {
                row1.Sougui_Reference = null;
            }
            ...
            row1.Kalys_Price = rs_tDBInput_1.getFloat(4);
...
ajout_tmp.product_name = row1.Original_Kalys_Name ;
ajout_tmp.categories = row1.Original_Kalys_Category ;
ajout_tmp.price = row1.Kalys_Price ;
...
modify_tmp.Produit_Klays_Id = row2.Produit_Klays_Id ;
modify_tmp.product_name = row1.Original_Kalys_Name ;
modify_tmp.categories = row1.Original_Kalys_Category ;
modify_tmp.price = row1.Kalys_Price ;
...
} else {pstmt_tDBOutput_1.setString(1, ajout.product_name);
}
...
} else {pstmt_tDBOutput_2.setString(1, modify.product_name);
}
...
pstmt_tDBOutput_2.setNull(5, java.sql.Types.VARCHAR);
                    ...
                    pstmt_tDBOutput_2.setInt(6 + count_tDBOutput_2, modify.Produit_Klays_Id);
 ...
 */
	...
	final String decryptedPassword_tDBInput_2 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:GKOI90+cW2C8qacOgrISQ9BbbIrgotYTqETZaGWdzefMRyZf");
		    ...
		    String dbquery_tDBInput_2 = "SELECT dbo.Dim_Produit_Kalys.Produit_Klays_Id,\n		dbo.Dim_Produit_Kalys.reference,\n		dbo.Dim_Produit_Kalys.source,\n		dbo"
...
+"Kalys";
		    ...
		    while (rs_tDBInput_2.next()) {
		        nb_line_tDBInput_2++;
							...
							if(colQtyInRs_tDBInput_2 < 1) {
								row2.Produit_Klays_Id = 0;
							} else {
		                          
            row2.Produit_Klays_Id = rs_tDBInput_2.getInt(1);
            ...
            row2.price = rs_tDBInput_2.getFloat(5);
            if(rs_tDBInput_2.wasNull()){
                    row2.price = null;
            }
		                    }
            ...
            if(tmpContent_tDBInput_2 != null) {
            	if (talendToDBList_tDBInput_2 .contains(rsmd_tDBInput_2.getColumnTypeName(6).toUpperCase(java.util.Locale.ENGLISH))) {
            		row2.categories = FormatterUtils.formatUnwithE(tmpContent_tDBInput_2);
            	} else {
                	row2.categories = tmpContent_tDBInput_2;
                }
            } else {
                row2.categories = null;
            }
 ...
 */
	...
	currentComponent="tAdvancedHash_row2";
				...
				row2_HashRow.Produit_Klays_Id = row2.Produit_Klays_Id;
 ...
 */
    ...
    public static void main(String[] args){
        final Dim_Produit_Kalys Dim_Produit_KalysClass = new Dim_Produit_Kalys();

        int exitCode = Dim_Produit_KalysClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = Dim_Produit_Kalys.class.getClassLoader().getResourceAsStream("souguietl/dim_produit_kalys_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = Dim_Produit_Kalys.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : Dim_Produit_Kalys");
        }
...
/************************************************************************************************
 *     121311 characters generated by Talend Open Studio for Data Integration 
