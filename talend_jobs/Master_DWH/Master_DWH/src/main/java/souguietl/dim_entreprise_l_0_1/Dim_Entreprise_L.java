...
package souguietl.dim_entreprise_l_0_1;
...
/**
 * Job: Dim_Entreprise_L Purpose: <br>
 * Description:  <br>
 * @author 
 * @version 8.0.1.20211109_1610
 * @status 
 */
public class Dim_Entreprise_L implements TalendJob {
...
protected static void logIgnoredError(String message, Throwable cause) {
	...
	private final String jobName = "Dim_Entreprise_L";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				Dim_Entreprise_L.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(Dim_Entreprise_L.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class ajoutStruct implements routines.system.IPersistableRow<ajoutStruct> {
    final static byte[] commonByteArrayLock_SOUGUIETL_Dim_Entreprise_L = new byte[0];
    static byte[] commonByteArray_SOUGUIETL_Dim_Entreprise_L = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_SOUGUIETL_Dim_Entreprise_L.length) {
				if(length < 1024 && commonByteArray_SOUGUIETL_Dim_Entreprise_L.length == 0) {
   					commonByteArray_SOUGUIETL_Dim_Entreprise_L = new byte[1024];
				} else {
   					commonByteArray_SOUGUIETL_Dim_Entreprise_L = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_SOUGUIETL_Dim_Entreprise_L, 0, length);
			strReturn = new String(commonByteArray_SOUGUIETL_Dim_Entreprise_L, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_SOUGUIETL_Dim_Entreprise_L, 0, length);
			strReturn = new String(commonByteArray_SOUGUIETL_Dim_Entreprise_L, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_SOUGUIETL_Dim_Entreprise_L) {
...
String dbUser_tDBOutput_1 = null;
	...
	final String decryptedPassword_tDBOutput_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:j1kkqCybfdbDRDvePREjB3NJXuF/AXTiOwMkuxdrlGcAyWtG");
...
if(dbschema_tDBOutput_1 == null || dbschema_tDBOutput_1.trim().length() == 0) {
    tableName_tDBOutput_1 = "Dim_Entreprise";
} else {
    tableName_tDBOutput_1 = dbschema_tDBOutput_1 + "].[" + "Dim_Entreprise";
}
	int count_tDBOutput_1=0;

        String insert_tDBOutput_1 = "INSERT INTO [" + tableName_tDBOutput_1 + "] ([Nom],[Matricule_fiscal],[Adresse],[latitude],[longitude]) VALUES (?,?,?,?,?)";
...
String dbUser_tDBOutput_2 = null;
	...
	final String decryptedPassword_tDBOutput_2 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:kJP83IFxUA2Ut1Kq5hYl+gO7J4cyguj9QEa02WP9N3si82Rg");
...
if(dbschema_tDBOutput_2 == null || dbschema_tDBOutput_2.trim().length() == 0) {
    tableName_tDBOutput_2 = "Dim_Entreprise";
} else {
    tableName_tDBOutput_2 = dbschema_tDBOutput_2 + "].[" + "Dim_Entreprise";
}
	int count_tDBOutput_2=0;

        String update_tDBOutput_2 = "UPDATE [" + tableName_tDBOutput_2 + "] SET [Nom] = ?,[Matricule_fiscal] = ?,[Adresse] = ?,[Latitude] = ?,[Longitude] = ? WHERE [Id_Client] = ?";
 ...
 */
	...
	final String decryptedPassword_tDBInput_2 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:0auWMZ3rK2vPp+0vb2o/lCSlvg3LDPtVUMBOENT3lOynLp9U");
		    ...
		    String dbquery_tDBInput_2 = "WITH CTE AS (\n    SELECT \n        Nom,\n        Matricule_fiscal,\n        Adresse,\n        latitude,\n        longi"
+"tude,\n        ROW_NUMBER() OVER (PARTITION BY Matricule_fiscal ORDER BY Nom) AS rn\n    FROM Entete_bl_SA\n)\nSELECT \n"
+"    Nom,\n    Matricule_fiscal,\n    Adresse,\n    latitude,\n    longitude\nFROM CTE\nWHERE rn = 1;";
            ...
            if(tmpContent_tDBInput_2 != null) {
            	if (talendToDBList_tDBInput_2 .contains(rsmd_tDBInput_2.getColumnTypeName(2).toUpperCase(java.util.Locale.ENGLISH))) {
            		row1.Matricule_fiscal = FormatterUtils.formatUnwithE(tmpContent_tDBInput_2);
            	} else {
                	row1.Matricule_fiscal = tmpContent_tDBInput_2;
                }
            } else {
                row1.Matricule_fiscal = null;
            }
            ...
            row1.latitude = rs_tDBInput_2.getDouble(4);
            ...
            row1.longitude = rs_tDBInput_2.getDouble(5);
            if(rs_tDBInput_2.wasNull()){
                    row1.longitude = null;
            }
		                    }
 					    ...
 					    boolean forceLooprow2 = false;
 							...
 							row2Struct row2ObjectFromLookup = null;
								...
								hasCasePrimitiveKeyWithNull_tMap_1 = false;
                        		    		    ...
                        		    		    row2HashKey.Matricule_fiscal = row1.Matricule_fiscal ;
				           		...
				           		if(tHash_Lookup_row2 != null && tHash_Lookup_row2.getCount(row2HashKey) > 1) { // G 071
									...
									//System.out.println("WARNING: UNIQUE MATCH is configured for the lookup 'row2' and it contains more one result from keys :  row2.Matricule_fiscal = '" + row2HashKey.Matricule_fiscal + "'");
								} // G 071
...
ajout_tmp.Nom = row1.Nom ;
ajout_tmp.Matricule_fiscal = row1.Matricule_fiscal ;
ajout_tmp.Adresse = row1.Adresse ;
ajout_tmp.latitude = row1.latitude ;
ajout_tmp.longitude = row1.longitude ;
ajout = ajout_tmp;
...
modify_tmp.Id_Client = row2.Id_Client ;
modify_tmp.Nom = row1.Nom ;
modify_tmp.Matricule_fiscal = row1.Matricule_fiscal ;
modify_tmp.Adresse = row1.Adresse ;
modify_tmp.Latitude =  row1.latitude ;
modify_tmp.Longitude = row1.longitude ;
modify = modify_tmp;
} // closing filter/reject
// ###############################
...
} else {pstmt_tDBOutput_1.setString(1, ajout.Nom);
}

                    if(ajout.Matricule_fiscal == null) {
pstmt_tDBOutput_1.setNull(2, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(2, ajout.Matricule_fiscal);
}

                    if(ajout.Adresse == null) {
pstmt_tDBOutput_1.setNull(3, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(3, ajout.Adresse);
}

                    if(ajout.latitude == null) {
pstmt_tDBOutput_1.setNull(4, java.sql.Types.DOUBLE);
} else {pstmt_tDBOutput_1.setDouble(4, ajout.latitude);
}

                    if(ajout.longitude == null) {
pstmt_tDBOutput_1.setNull(5, java.sql.Types.DOUBLE);
} else {pstmt_tDBOutput_1.setDouble(5, ajout.longitude);
}
...
} else {pstmt_tDBOutput_2.setString(1, modify.Nom);
}

                    if(modify.Matricule_fiscal == null) {
pstmt_tDBOutput_2.setNull(2, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_2.setString(2, modify.Matricule_fiscal);
}

                    if(modify.Adresse == null) {
pstmt_tDBOutput_2.setNull(3, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_2.setString(3, modify.Adresse);
}

                    if(modify.Latitude == null) {
pstmt_tDBOutput_2.setNull(4, java.sql.Types.DOUBLE);
} else {pstmt_tDBOutput_2.setDouble(4, modify.Latitude);
}

                    if(modify.Longitude == null) {
pstmt_tDBOutput_2.setNull(5, java.sql.Types.DOUBLE);
} else {pstmt_tDBOutput_2.setDouble(5, modify.Longitude);
}


                    pstmt_tDBOutput_2.setInt(6 + count_tDBOutput_2, modify.Id_Client);
 ...
 */
	...
	final String decryptedPassword_tDBInput_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:EOs8eJIRYNZ8PeGykYvb9wRnf9onMPw4v0L+5MzL6q7XEI0b");
		    ...
		    String dbquery_tDBInput_1 = "SELECT \n    MAX(dbo.Dim_Entreprise.Id_Client) AS Id_Client,\n    MAX(dbo.Dim_Entreprise.Nom) AS Nom,\n    dbo.Dim_Entr"
+"eprise.Matricule_fiscal,\n    MAX(dbo.Dim_Entreprise.Adresse) AS Adresse,\n    MAX(dbo.Dim_Entreprise.Latitude) AS Latit"
+"ude,\n    MAX(dbo.Dim_Entreprise.Longitude) AS Longitude\nFROM dbo.Dim_Entreprise\nGROUP BY dbo.Dim_Entreprise.Matricule"
+"_fiscal;";
            ...
            row2.Id_Client = rs_tDBInput_1.getInt(1);
            ...
            if(tmpContent_tDBInput_1 != null) {
            	if (talendToDBList_tDBInput_1 .contains(rsmd_tDBInput_1.getColumnTypeName(3).toUpperCase(java.util.Locale.ENGLISH))) {
            		row2.Matricule_fiscal = FormatterUtils.formatUnwithE(tmpContent_tDBInput_1);
            	} else {
                	row2.Matricule_fiscal = tmpContent_tDBInput_1;
                }
            } else {
                row2.Matricule_fiscal = null;
            }
            ...
            row2.Latitude = rs_tDBInput_1.getDouble(5);
            if(rs_tDBInput_1.wasNull()){
                    row2.Latitude = null;
            }
		                    }
            ...
            row2.Longitude = rs_tDBInput_1.getDouble(6);
            if(rs_tDBInput_1.wasNull()){
                    row2.Longitude = null;
            }
		                    }
 ...
 */
	...
	currentComponent="tAdvancedHash_row2";
				...
				row2_HashRow.Matricule_fiscal = row2.Matricule_fiscal;
 ...
 */
    ...
    public static void main(String[] args){
        final Dim_Entreprise_L Dim_Entreprise_LClass = new Dim_Entreprise_L();

        int exitCode = Dim_Entreprise_LClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = Dim_Entreprise_L.class.getClassLoader().getResourceAsStream("souguietl/dim_entreprise_l_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = Dim_Entreprise_L.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : Dim_Entreprise_L");
        }
...
/************************************************************************************************
 *     123294 characters generated by Talend Open Studio for Data Integration 
