...
package souguietl.dim_produit_sougui_l_0_1;
...
/**
 * Job: Dim_Produit_Sougui_L Purpose: <br>
 * Description:  <br>
 * @author 
 * @version 8.0.1.20211109_1610
 * @status 
 */
public class Dim_Produit_Sougui_L implements TalendJob {
...
protected static void logIgnoredError(String message, Throwable cause) {
	...
	private final String jobName = "Dim_Produit_Sougui_L";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				Dim_Produit_Sougui_L.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(Dim_Produit_Sougui_L.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class ajoutStruct implements routines.system.IPersistableRow<ajoutStruct> {
    final static byte[] commonByteArrayLock_SOUGUIETL_Dim_Produit_Sougui_L = new byte[0];
    static byte[] commonByteArray_SOUGUIETL_Dim_Produit_Sougui_L = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_SOUGUIETL_Dim_Produit_Sougui_L.length) {
				if(length < 1024 && commonByteArray_SOUGUIETL_Dim_Produit_Sougui_L.length == 0) {
   					commonByteArray_SOUGUIETL_Dim_Produit_Sougui_L = new byte[1024];
				} else {
   					commonByteArray_SOUGUIETL_Dim_Produit_Sougui_L = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_SOUGUIETL_Dim_Produit_Sougui_L, 0, length);
			strReturn = new String(commonByteArray_SOUGUIETL_Dim_Produit_Sougui_L, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_SOUGUIETL_Dim_Produit_Sougui_L, 0, length);
			strReturn = new String(commonByteArray_SOUGUIETL_Dim_Produit_Sougui_L, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_SOUGUIETL_Dim_Produit_Sougui_L) {
...
String dbUser_tDBOutput_1 = null;
	...
	final String decryptedPassword_tDBOutput_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:WQfSORU9OBDwRdHLk1TCR023dUnF7IAgU5Kjofn0xtWycmSV");
...
if(dbschema_tDBOutput_1 == null || dbschema_tDBOutput_1.trim().length() == 0) {
	...
	int count_tDBOutput_1=0;
        ...
        String insert_tDBOutput_1 = "INSERT INTO [" + tableName_tDBOutput_1 + "] ([Reference],[Description]) VALUES (?,?)";
...
String dbUser_tDBOutput_2 = null;
	...
	final String decryptedPassword_tDBOutput_2 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:apA9k7GmKC3kQwslPZF5u1FpCwLyTichl6lzPUk2NGq2KphY");
...
if(dbschema_tDBOutput_2 == null || dbschema_tDBOutput_2.trim().length() == 0) {
	...
	int count_tDBOutput_2=0;
        ...
        String update_tDBOutput_2 = "UPDATE [" + tableName_tDBOutput_2 + "] SET [Reference] = ?,[Description] = ? WHERE [Id_Produit] = ?";
 ...
 */
	...
	final String decryptedPassword_tDBInput_2 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:Ps8kraYdwBCGHuKW7JN6zr2FaBYAmSWV9/nseIaWkg7fQXC8");
...
+"erence];";
            ...
            if(tmpContent_tDBInput_2 != null) {
            	if (talendToDBList_tDBInput_2 .contains(rsmd_tDBInput_2.getColumnTypeName(2).toUpperCase(java.util.Locale.ENGLISH))) {
            		row1.Description = FormatterUtils.formatUnwithE(tmpContent_tDBInput_2);
            	} else {
                	row1.Description = tmpContent_tDBInput_2;
                }
            } else {
                row1.Description = null;
            }
...
ajout_tmp.Description = row1.Description ;
ajout = ajout_tmp;
...
modify_tmp.Description = row1.Description ;
modify = modify_tmp;
} // closing filter/reject
// ###############################
...
pstmt_tDBOutput_2.setNull(2, java.sql.Types.VARCHAR);
                    ...
                    pstmt_tDBOutput_2.setInt(3 + count_tDBOutput_2, modify.Id_Produit);
 ...
 */
	...
	final String decryptedPassword_tDBInput_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:0QBAmLRlXpycniZwBp2M3HBuHpnY9AgnOJwaew4Ogxqf+sWw");
...
+"bo.Dim_Produit_Sougui.PU_HT\nFROM	dbo.Dim_Produit_Sougui";
            ...
            row2.PU_HT = rs_tDBInput_1.getFloat(4);
            if(rs_tDBInput_1.wasNull()){
                    row2.PU_HT = null;
            }
		                    }
 ...
 */
    ...
    public static void main(String[] args){
        final Dim_Produit_Sougui_L Dim_Produit_Sougui_LClass = new Dim_Produit_Sougui_L();

        int exitCode = Dim_Produit_Sougui_LClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = Dim_Produit_Sougui_L.class.getClassLoader().getResourceAsStream("souguietl/dim_produit_sougui_l_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = Dim_Produit_Sougui_L.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : Dim_Produit_Sougui_L");
        }
...
/************************************************************************************************
 *     107945 characters generated by Talend Open Studio for Data Integration 
